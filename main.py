...
📌 المطلوب:
أرسل فقط JSON صالح 100%، يبدأ بـ `[` وينتهي بـ `]`. بدون أي شرح خارجه. النتيجة يجب أن تكون على هذا الشكل:
[
  [
    {
      "type": "mcq",
      "question": "ما معنى الجملة: 'I can't believe this'؟",
      "options": [
        "لا أصدق ذلك",
        "أريد هذا",
        "هل تفهمني؟",
    ...
    {
      "type": "fill_blank",
      "question": "أكمل الجملة: We should try ____ tomorrow.",
      "options": [
        "again",
        "before",
        "never",
  ...
  [
    {
      "type": "mcq",
      "question": "ما مرادف كلمة 'confused'؟",
      "options": [
        "مرتبك",
        "سعيد",
        "غاضب",
    ...
    {
      "type": "true_false",
      "question": "الجملة 'She was late again.' تعني أنها حضرت مبكرًا.",
      "options": [
        "True",
        "False"
      ],
  ...
  [
    {
      "type": "mcq",
      "question": "ما المقصود بـ 'He gave up easily'؟",
      "options": [
        "استسلم بسرعة",
        "حاول كثيرًا",
        "فاز بالمباراة",
    ...
    {
      "type": "fill_blank",
      "question": "أكمل الجملة: They didn't ____ what to do.",
      "options": [
        "know",
        "knew",
        "knowing",
